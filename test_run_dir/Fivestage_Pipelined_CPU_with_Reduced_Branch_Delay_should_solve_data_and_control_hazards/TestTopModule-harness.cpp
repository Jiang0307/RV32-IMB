...
#endif
#if VM_COVERAGE
  VerilatedCov::write(R"(/mnt/c/Users/User/Desktop/GitHub/RV32-IMB/test_run_dir/Fivestage_Pipelined_CPU_with_Reduced_Branch_Delay_should_solve_data_and_control_hazards/coverage.dat)");
#endif
  top->final();
  // TODO: re-enable!
  // delete top;
...
static sim_state* create_sim_state() {
  ...
  std::string dumpfile = R"(/mnt/c/Users/User/Desktop/GitHub/RV32-IMB/test_run_dir/Fivestage_Pipelined_CPU_with_Reduced_Branch_Delay_should_solve_data_and_control_hazards/TestTopModule.)";
