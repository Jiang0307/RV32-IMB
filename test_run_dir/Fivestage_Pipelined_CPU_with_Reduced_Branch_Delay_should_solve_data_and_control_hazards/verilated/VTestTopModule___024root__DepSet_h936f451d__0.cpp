...
void VTestTopModule___024root___eval_triggers__act(VTestTopModule___024root* vlSelf) {
    ...
    vlSelf->__VactTriggered.set(1U, ((IData)(vlSelf->TestTopModule__DOT__cpu__DOT__cpu__DOT__if2id__DOT__instruction_clock) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__TestTopModule__DOT__cpu__DOT__cpu__DOT__if2id__DOT__instruction_clock__0))));
